...
export const BUILDING_TYPE_VOCABULARY: Record<CanonicalBuildingType, Record<string, string>> = {
  ...
  school: {
    ...
    "speech":           "CLASSROOM SIGN",
    "speech room":      "CLASSROOM SIGN",
    "speech therapy":   "CLASSROOM SIGN",
    "debate":           "CLASSROOM SIGN",
    "computer":         "CLASSROOM SIGN",
    "video":            "CLASSROOM SIGN",
    "audio":            "CLASSROOM SIGN",
    "av room":          "CLASSROOM SIGN",
    "special education": "CLASSROOM SIGN",
    "special ed":       "CLASSROOM SIGN",
    "sped":             "CLASSROOM SIGN",
    "breakout":         "CLASSROOM SIGN",
    "break out":        "CLASSROOM SIGN",
    "small group":      "CLASSROOM SIGN",
    "garden":           "CLASSROOM SIGN",
    // Grade level rooms
    ...
    gym:              "GYMNASIUM SIGN",
    "kitchen":        "CAFETERIA SIGN",
    "cooler":         "STORAGE SIGN",
    "freezer":        "STORAGE SIGN",
    "lunch room":     "CAFETERIA SIGN",
    "lunch":          "CAFETERIA SIGN",
    "serving":        "CAFETERIA SIGN",
    // PE / athletics
    locker:           "LOCKER ROOM SIGN",
    "weight room":    "GYMNASIUM SIGN",
    "pe":             "GYMNASIUM SIGN",
    "physical education": "GYMNASIUM SIGN",
    "play area":      "GYMNASIUM SIGN",
    "playground":     "GYMNASIUM SIGN",
    "equipment room": "STORAGE SIGN",
    "equipment":      "STORAGE SIGN",
    "pt":             "OFFICE SIGN",
    // Break / lounge
    "break room":     "BREAK ROOM SIGN",
    "teacher lounge": "BREAK ROOM SIGN",
    // Entry / circulation
    "vestibule":      "LOBBY SIGN",
    // Support
